    ...
    <footer className="flex items-center justify-center w-full border-t border-gray-800 bg-primary">
      <div className="py-12 max-w-notebook">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="flex flex-col">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-[#06C8D6] to-[#04A5B8] rounded-lg flex items-center justify-center">
          ...
          <div className="flex flex-col">
            <h4 className="text-lg font-semibold text-[#06C8D6] mb-4">
              Enlaces Rápidos
            </h4>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4 mb-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center hover:bg-[#06C8D6] transition-colors"
              >
        ...
        <div className="pt-8 mt-8 text-center border-t border-gray-800">
          <p className="text-sm text-gray-400">
            © {currentYear} Fitness Center. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
